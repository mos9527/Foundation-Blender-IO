...
- `EXT_foundation_lights` (Foundation private extension; see [draft](EXT_foundation_lights.md))
- `EXT_foundation_animation` (Foundation private extension; see [draft](EXT_foundation_animation.md))
Installation
---
