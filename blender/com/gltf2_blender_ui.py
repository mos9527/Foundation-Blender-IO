...
class NODE_OT_GLTF_SETTINGS(bpy.types.Operator):
    ...
    def poll(cls, context):
        ...
        return (
            ...
            and bpy.context.preferences.addons[__package__.split('.')[0]].preferences.settings_node_ui is True
        )
...
def add_gltf_settings_to_menu(self, context):
    if bpy.context.preferences.addons[__package__.split('.')[0]].preferences.settings_node_ui is True:
...
class SCENE_PT_gltf2_variants(bpy.types.Panel):
    ...
    @classmethod
    def poll(cls, context):
        return bpy.context.preferences.addons[__package__.split('.')[0]].preferences.KHR_materials_variants_ui is True
...
class SCENE_PT_gltf2_animation(bpy.types.Panel):
    ...
    @classmethod
    def poll(cls, context):
        return bpy.context.preferences.addons[__package__.split('.')[0]].preferences.animation_ui is True
