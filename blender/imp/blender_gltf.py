...
class BlenderGlTF():
    ...
    def manage_material_variants(gltf):
        ...
        if bpy.context.preferences.addons[__package__.split('.')[0]].preferences.KHR_materials_variants_ui is False:
            bpy.context.preferences.addons[__package__.split('.')[0]].preferences.KHR_materials_variants_ui = True
